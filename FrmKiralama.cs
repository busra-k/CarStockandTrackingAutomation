...
namespace ProGarage.KademeKiralama
{
    public partial class FrmKiralama : Form
    {
        ...
        private struct RgbColors
        {
            ...
            public static Color color7 = Color.FromArgb(31, 131, 231);
        ...
        private void ıconButton1_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm(new KademeServis.FrmAracEkle());
        ...
        private void ıconButton4_Click(object sender, EventArgs e)
        {
           ...
           OpenChildForm(new KademeKiralama.FrmMuhasebe());
        ...
        private void ıconButton6_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm(new KademeKiralama.FrmAracKiralama());
        }
        ...
        private void ıconButton2_Click_1(object sender, EventArgs e)
        {
            ...
            OpenChildForm(new KademeKiralama.FrmKiralanmisArac());
        }
    }
}
